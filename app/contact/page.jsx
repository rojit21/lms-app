              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Simply browse our course catalog, select a course you're interested in, and click the "Enroll" button. 
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    We offer a 30-day money-back guarantee for all paid courses. If you're not satisfied, 
                    contact our support team within 30 days of purchase.
                  </p>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">How do I become an instructor?</h4>
                  <p className="text-gray-600 text-sm">
                    To become an instructor, register for an account and select "Creator" as your role. 
                    You can then upload courses and start teaching.
                  </p>
                </div>
              </div>
            </div>
